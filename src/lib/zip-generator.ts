...
function generateReadme(config: ThemeConfig, exports: ExportResult[]): string {
  ...
  return `# ${config.displayName} Theme Bundle

Thank you for purchasing the ${config.displayName} theme from Theme Bundle!
...
- Email: support@themebundle.com
- Website: https://themebundle.com/support
...
When using this theme in a public project, a credit to Theme Bundle
...
- Email: licensing@themebundle.com
- Website: https://themebundle.com
 ...
 * Export for testing
 */
export { generateReadme, generateLicense };
